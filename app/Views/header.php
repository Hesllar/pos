...
<body>
    ...
    <div class="wrapper homepage">
        ...
        <div class="popup_wrapper">
            <div class="test">
                <span class="popup_off">Cerrar</span>
                <div class="subscribe_area text-center mt-60">
                    <h2>Bolet&iacute;n Informativo</h2>
                    <p>Suscr&iacute;base a la lista de correo de Ferme para recibir actualizaciones sobre nuevos
                        productos, stock, ofertas especiales e información sobre descuentos.</p>
                    ...
                    <div class="subscribe-bottom mt-15">
                        ...
                        <label for="newsletter-permission">No volver a mostrar</label>
                    </div>
                </div>
            </div>
        </div> -->
                                    ...
                                    <ul class="middle-menu-list">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>/productos">Productos<i class="fa fa-angle-down"></i></a>
                                            ...
                                            <ul class="ht-dropdown dropdown-style-two">
                                                ...
                                                <li><a href="compare.html">Pinturas</a></li>
                                                <li><a href="cart.html">Maderas</a></li>
                                                <li><a href="checkout.html">Herramientas electricas</a></li>
                                            </ul>
                                            <!-- Home Version Dropdown End -->
                                        </li>
