                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="register-title">
                            ...
                            <p class="mb-10">Si ya tienes una cuenta, por favor <a href="<?php echo base_url() ?>/acceder">inicia sesi&oacute;n</a>.</p>
                        </div>
                    </div>
                </div>
                <!-- Row End -->
                        ...
                        <form class="form-horizontal" action="#">
                            ...
                            <div class="buttons newsletter-input">
                                <div class="pull-right">I have read and agree to the <a href="#" class="agree"><b>Privacy Policy</b></a>
                                    ...
                                    <input type="submit" value="Crear cuenta" class="newsletter-btn">
                                </div>
                            </div>
                        </form>
                    </div>
